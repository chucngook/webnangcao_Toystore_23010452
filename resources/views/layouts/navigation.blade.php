        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    {{-- Sửa link logo về trang chủ để thân thiện với mọi người dùng --}}
                    <a href="{{ route('home') }}">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    {{-- Link Dashboard chỉ hiển thị khi đã đăng nhập --}}
                    @auth
                    ...
                    {{-- Link đến trang sản phẩm cho tất cả mọi người --}}
            ...
            <!-- Settings Dropdown hoặc Link Đăng nhập/Đăng ký -->
